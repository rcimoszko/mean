...
module.exports = {
    ...
    cloudinary: {
        cloud_name: getCred('mean-cloudinary', 'cloud_name') || 'CLIENT_ID',
        api_key: getCred('meancloudinaryl', 'api_key') || 'CLIENT_ID',
        api_secret: getCred('mean-cloudinary', 'api_secret') || 'CLIENT_ID'
    },
    stripe: {
        secretKey: getCred('mean-stripe', 'secretKey') || 'CLIENT_ID'
    },
    mailchimp: {
        secretKey: getCred('mean-mailchimp', 'apiKey') || 'CLIENT_ID',
        listName: getCred('mean-mailchimp', 'apiKey') || 'CLIENT_ID'
    }
};